...
namespace BusinessLayer.Validationrules
{
    public class CategoryValidator:AbstractValidator<Category>
    {
        ...
        {
            RuleFor(x => x.CategoryName).NotEmpty().WithMessage("Kategori adını boş geçemzsiniz.");
            RuleFor(x => x.CategoryDescription).NotEmpty().WithMessage("Kategori açıklamasını boş geçemzsiniz.");
